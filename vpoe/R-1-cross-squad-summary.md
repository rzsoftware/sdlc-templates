# R-1: VPoE Cross-Squad Pipeline Summary
...
**Subject:** Sprint [NEXT SPRINT #] Pipeline Summary — All Squads
...
|---|---|---|
| **Sprint number in quarter** | ___ of ___ | |
| **Squads starved this quarter** | ___ | ___ total instances |
| **Cumulative unrealized capacity** | ___ pts | ___ pts |
| **Partial Definition Overrides** | ___ | ___ total |

## Actions

<!-- DELETE IF NONE NEEDED: -->

_No action required. All squads loading at healthy capacity._
...
_This is a scheduled process report compiled from Squad Lead R-1 submissions._
